function eventListeners(){document.querySelector(".mobile-menu").addEventListener("click",navegacionResposive)}function navegacionResposive(){document.querySelector(".navegacion").classList.toggle("mostrar")}
